...
libraryDependencies ++= Seq(
  ...
  "com.github.cornerman" %%% "colibri-zio"       % "@VERSION_COLIBRI@", // zio support
  "com.github.cornerman" %%% "colibri-fs2"       % "@VERSION_COLIBRI@", // fs2 support
  "com.github.cornerman" %%% "colibri-airstream" % "@VERSION_COLIBRI@", // sirstream support
  "com.github.cornerman" %%% "colibri-rx"        % "@VERSION_COLIBRI@", // scala.rx support
  "com.github.cornerman" %%% "colibri-router"    % "@VERSION_COLIBRI@", // Url Router support
)
