...
trait CompatFactory[F[+_]] extends OutwatchOps[F] { this: DomTypesFactory[F] =>
  ...
  trait Handlers {
    ...
    def createHandler[T](defaultValues: T*)(implicit s: Scheduler): F[Pipe[T, T]] = Handler.create[T](defaultValues: _*)
  }
  ...
  trait AttributesCompat extends OutWatchChildAttributesCompat {
    self: Attributes =>
