...
private[outwatch] trait TagBuilder extends builders.HtmlTagBuilder[TagBuilder.Tag, dom.html.Element] with builders.SvgTagBuilder[TagBuilder.Tag, dom.svg.Element] {
  ...
  protected override def htmlTag[Ref <: dom.html.Element](tagName: String, void: Boolean): BasicVNode = HtmlVNode(tagName, js.Array())
  protected override def svgTag[Ref <: dom.svg.Element](tagName: String, void: Boolean): BasicVNode = SvgVNode(tagName, js.Array())
}
